...
3. Run `scripts/bootstrap_venv.sh` and `source backend/.venv/bin/activate` if you need tests.
4. Implement review artifacts/changes and commit there (do not work on `main` or `marin`).
